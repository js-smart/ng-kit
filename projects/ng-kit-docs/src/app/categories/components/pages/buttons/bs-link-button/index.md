...
## API Reference
The Bootstrap Link Button extends the Base Button and overrides below properties for link behavior. See [Base Button](/components/buttons/base-button#api-reference) for inherited properties.
